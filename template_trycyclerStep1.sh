...
for X in BCJB1835 BCJB2983 BCJB3343 BCJB3344 BCJB3586 BCJB4361 ; do #For XXXX insert strain or accession numbers#
		...
		### THIS WILL PRODUCE cluster tree graphs, ideally they are very clean (clean clusters of short length leafs in clean separate branches)
		### If there are 'messy' trees with lots of different length branches and strange leafs (wrong genome size and/or not reasonable plasmid size)
		### RENAME 'messy' clustering to start with '.bad_<cluster##>_short' to ignore the directory and facilitate continuation of assembly.
